...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <h4 class="mb-2 mx-2">{{ __('Unauthorized Access') }} ⚠️</h4>
    <p class="mb-6 mx-2">{{ __('you do not have permission to access this page') }}</p>
    <a href="{{url('/')}}" class="btn btn-primary mb-10">{{ __('Back to home') }}</a>
    <div class="mt-4">
      <img src="{{ asset('assets/img/illustrations/unauthorized-access.svg') }}" alt="page-misc-error" width="225" class="img-fluid">
    </div>
  </div>
</div>
